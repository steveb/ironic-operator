...
replace (
	github.com/openstack-k8s-operators/lib-common => github.com/steveb/lib-common v0.0.0-20221002220942-a040fb74f50c
	github.com/openstack-k8s-operators/lib-common/modules/common => github.com/steveb/lib-common/modules/common v0.0.0-20221002220942-a040fb74f50c
	github.com/openstack-k8s-operators/lib-common/modules/database => github.com/steveb/lib-common/modules/database v0.0.0-20221002220942-a040fb74f50c
	github.com/openstack-k8s-operators/lib-common/modules/openstack => github.com/steveb/lib-common/modules/openstack v0.0.0-20221002220942-a040fb74f50c
)

//replace (
//	github.com/openstack-k8s-operators/lib-common/modules/common => ../lib-common/modules/common
//	github.com/openstack-k8s-operators/lib-common/modules/database => ../lib-common/modules/database
//	github.com/openstack-k8s-operators/lib-common/modules/openstack => ../lib-common/modules/openstack
//)
